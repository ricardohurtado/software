...
<html>
    ...
    <body class="skin-green layout-top-nav">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-1">
                                            <div class="form-group">
                                                <label>Dsct. 1</label>
                                                <input type="text" class="form-control input-sm" id="txtdescuento1" />
                                            </div>
                                        </div>
                                        <div class="col-xs-1">
                                            <div class="form-group">
                                                <label>Dsct. 2</label>
                                                <input type="text" class="form-control input-sm" id="txtdescuento2" />
                                            </div>
                                        </div>
                                        <div class="col-xs-2">
                                            <div class="form-group">
        ...
        <script src="js/articulo.autocompletar.js" type="text/javascript"></script>
